...
#pragma warning restore 618
        ...
        public Transform GetStartPositionName(string containsname)
        {
            // first remove any dead transforms
            startPositions.RemoveAll(t => t == null);
            ...
            {
                if (startPositions[i].gameObject.name.Contains(containsname))
                    poses.Add(startPositions[i]);
            }
            ...
            if (playerSpawnMethod == PlayerSpawnMethod.Random)
            {
                return poses[UnityEngine.Random.Range(0, poses.Count)];
            }
            else
            {
                return poses[UnityEngine.Random.Range(0, poses.Count)];
